...
class Admin_ajax_pagination{
    ...
    var $last_link       = 'Last';
    var $uri_segment     = 3;
    var $full_tag_open   = '<nav aria-label="Page navigation example"><ul class="pagination justify-content-end">';
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            $info = '<ul class="pagination justify-content-end"><li class="page-number">Showing : ' . $this->total_rows .' of ' . $this->total_rows .'</li></ul>';
            return $info;
        }
        ...
        if ($this->show_count){
            ...
            $info = '<li class="page-number">Showing ' . ( $curr_offset + 1 ) . ' to ' ;
