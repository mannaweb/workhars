	...
	<div class="card-header py-3 forms">
		<div class="row form-row mb-2">
			...
			<div class="col-sm-6 text-right">
				...
				<a href="<?php echo base_url()?>admin/add-subcategory" class="btn btn-sm btn-success" data-tooltip="Add"><i class="fa fa-plus"></i></a>
				<?php } ?>
		...
		<div class="row form-row">
			...
			<div class="col-sm-6 col-md-6 col-lg-4 col-xl-4 offset-xl-1">
				<div class="form-group">
