...
<?php if($faqs){ foreach($faqs as $key=>$val){?>
	<tr>
		<td width="50">
		...
		<div class="form-group m-0">
			...
			<?php if(getUserDetails($this->session->userdata('user_id'),'role_manage') && in_array('edit-faq', getUserDetails($this->session->userdata('user_id'),'role_manage'))){?>

		<td><a href="<?php echo base_url()?>admin/edit-faq/<?php echo $val->id;?>" target="_blank"><?php echo $val->question;?></a></td>
		...
		<td>
			<div class="dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right">
					...
					<?php if(getUserDetails($this->session->userdata('user_id'),'role_manage') && in_array('change-status-faq', getUserDetails($this->session->userdata('user_id'),'role_manage'))){?>
