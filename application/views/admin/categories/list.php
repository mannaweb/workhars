	...
	<div class="card-header py-3 forms">
		<div class="row form-row mb-2">
			<div class="col-sm-6 d-flex">
				<h6 class="title my-auto">Categories list</h6>
			</div>
			<div class="col-sm-6 text-right">
				<?php if(getUserDetails($this->session->userdata('user_id'),'role_manage') && in_array('add-category', getUserDetails($this->session->userdata('user_id'),'role_manage'))){?>
				<a href="<?php echo base_url()?>admin/add-category" class="btn btn-sm btn-success" data-tooltip="Add"><i class="fa fa-plus"></i></a>
				<?php } ?>
		...
		<div class="row form-row">
			...
			<div class="col-sm-6 col-md-6 col-lg-2 col-xl-2">
				<div class="form-group">
					<select class="form-control select2-nosearch" id="popular" onchange="searchFilter()">
						<option value="" selected>Select Popular</option>
				...
				<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
					<thead>
						<tr>
							...
							<th>
								<a href="javascript:void(0)" class="sorting created_at" onclick="sortBy('created_at','category.created_at','ASC')">
