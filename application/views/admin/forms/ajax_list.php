<?php if($forms){ foreach($forms as $key=>$val){?>
	...
	<tr>
		...
		<?php if(getUserDetails($this->session->userdata('user_id'),'role_manage') && in_array('edit-form', getUserDetails($this->session->userdata('user_id'),'role_manage'))){?>

            <td><a href="<?php echo base_url()?>admin/edit-form/<?php echo $val->id;?>" target="_blank"><?php echo $val->name;?></a></td>

          

             <td><a href="<?php echo base_url()?>admin/edit-form/<?php echo $val->id;?>" target="_blank"><?php echo date('d M, Y',strtotime($val->created));?></a></td>
         ...
         <?php } else { ?>
           ...
           <td><?php echo $val->name;?></td>
            ...
            <td><?php echo date('jS M, Y',strtotime($val->created));?></td>
		...
		<td>
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right">
					...
					<a class="dropdown-item" href="<?php echo base_url()?>admin/edit-form/<?php echo $val->id;?>"><i class="fas fa-fw fa-edit"></i> Edit</a>

					<?php } ?>

					<?php if(getUserDetails($this->session->userdata('user_id'),'role_manage') && in_array('change-status-form', getUserDetails($this->session->userdata('user_id'),'role_manage'))){?>
